...
class Model(nn.Module):
    def __init__(self):
        ...
        self.pnnx_fold_pe_1_1_data = self.load_pnnx_bin_as_parameter(archive, 'pnnx_fold_pe.1_1.data', (1,30,), 'float32')
    ...
    def forward(self, v_0, v_1):
        v_2 = self.pnnx_fold_pe_1_1_data
        v_3 = v_2.clone()
        v_4 = self.pnnx_fold_div_term_1_data
        v_5 = self.pnnx_fold_div_term_1_1_data
        v_6 = v_1.unsqueeze(1)
        v_7 = v_6.to(copy=False, dtype=torch.float)
        v_8 = torch.sin((v_7 * v_4))
        v_9 = v_3
        v_9[:,::2] = v_8
        v_10 = v_9.clone()
        v_11 = torch.cos((v_7 * v_5))
        v_12 = v_10
        v_12[:,1::2] = v_11
        v_13 = self.image_to(v_0)
        v_14 = self.enc_0_temb_to_ch(v_12)
        v_15 = self.enc_0_conv1(v_13)
        v_16 = self.enc_0_act(v_15)
        v_17 = v_14.reshape(1, 64, 1, 1)
        v_18 = (v_16 + v_17)
        v_19 = self.enc_0_conv2(v_18)
        v_20 = self.pnnx_unique_0(v_19)
        v_21 = self.enc_0_conv3(v_20)
        v_22 = self.pnnx_unique_1(v_21)
        v_23 = (v_22 + v_13)
        v_24 = torch.clone(input=v_23)
        v_25 = self.downsamplers_0(v_23)
        v_26 = self.enc_1_temb_to_ch(v_12)
        v_27 = self.enc_1_conv1(v_25)
        v_28 = self.enc_1_act(v_27)
        v_29 = v_26.reshape(1, 128, 1, 1)
        v_30 = (v_28 + v_29)
        v_31 = self.enc_1_conv2(v_30)
        v_32 = self.pnnx_unique_2(v_31)
        v_33 = self.enc_1_conv3(v_32)
        v_34 = self.pnnx_unique_3(v_33)
        v_35 = (v_34 + v_25)
        v_36 = torch.clone(input=v_35)
        v_37 = self.downsamplers_1(v_35)
        v_38 = self.enc_2_temb_to_ch(v_12)
        v_39 = self.enc_2_conv1(v_37)
        v_40 = self.enc_2_act(v_39)
        v_41 = v_38.reshape(1, 256, 1, 1)
        v_42 = (v_40 + v_41)
        v_43 = self.enc_2_conv2(v_42)
        v_44 = self.pnnx_unique_4(v_43)
        v_45 = self.enc_2_conv3(v_44)
        v_46 = self.pnnx_unique_5(v_45)
        v_47 = (v_46 + v_37)
        v_48 = torch.flatten(input=v_47, end_dim=-1, start_dim=2)
        v_49 = v_48.permute(dims=(0,2,1))
        v_50 = self.to_query(v_49)
        v_51 = self.to_key(v_49)
        v_52 = self.to_value(v_49)
        v_53, _ = self.attention(v_50, v_51, v_52, need_weights=False)
        v_54 = self.out_proj(v_53)
        v_55 = v_54.permute(dims=(0,2,1))
        v_56 = v_55.reshape(1, 256, 8, 8)
        v_57 = (v_47 + v_56)
        v_58 = self.upsamplers_0(v_57)
        v_59 = torch.cat((v_58, v_36), dim=1)
        v_60 = self.dec_0_temb_to_ch(v_12)
        v_61 = self.dec_0_conv1(v_59)
        v_62 = self.dec_0_act(v_61)
        v_63 = v_60.reshape(1, 128, 1, 1)
        v_64 = (v_62 + v_63)
        v_65 = self.dec_0_conv2(v_64)
        v_66 = self.pnnx_unique_6(v_65)
        v_67 = self.dec_0_conv3(v_66)
        v_68 = self.pnnx_unique_7(v_67)
        v_69 = (v_68 + v_58)
        v_70 = self.upsamplers_1(v_69)
        v_71 = torch.cat((v_70, v_24), dim=1)
        v_72 = self.dec_1_temb_to_ch(v_12)
        v_73 = self.dec_1_conv1(v_71)
        v_74 = self.dec_1_act(v_73)
        v_75 = v_72.reshape(1, 64, 1, 1)
        v_76 = (v_74 + v_75)
        v_77 = self.dec_1_conv2(v_76)
        v_78 = self.pnnx_unique_8(v_77)
        v_79 = self.dec_1_conv3(v_78)
        v_80 = self.pnnx_unique_9(v_79)
        v_81 = (v_80 + v_70)
        v_82 = self.to_image(v_81)
        return v_82
